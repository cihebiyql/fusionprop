...
# --- Configuration ---
# Base directory where your training output (e.g., train_12_3_1) is located.
# The script assumes it's run from the EE_toxicity directory or that paths below are adjusted.
BASE_EXPERIMENT_DIR_PARENT="/HOME/scz0brz/run/EE_toxicity/train_12_3_1"
...
MAIN_OUTPUT_DIR="./evaluation_output_all_models_12_3_1"

# Path to the aggregated results JSON file
AGGREGATE_JSON_PATH="${MAIN_OUTPUT_DIR}/all_metrics_summary_12_3_1.json"
